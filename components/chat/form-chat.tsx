...
export default function FormChat({isLoading, input, handleInputChange, handleSubmit}:FormChatProps) {
    return (
        <div className="fixed bottom-0 right-0 left-0 max-w-[800px] mx-auto">
            <div className="py-3 sm:py-5 md:py-8 px-3 bg-background/90 backdrop-blur-md">
                <form className="flex items-center gap-2" onSubmit={handleSubmit}>
                    <Input className="w-full" placeholder="Envoyer un message"  value={input} disabled={isLoading} onChange={handleInputChange} />
